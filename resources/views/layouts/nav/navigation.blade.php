        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar"
                    type="button"
                    class="inline-flex items-center p-2 text-sm rounded-lg sm:hidden text-gray-400 hover:bg-gray-700 focus:ring-gray-600">
                    ...
                    <div>
                        <button type="button"
                            ...
                            <img class="w-8 h-8 rounded-full"
                                src="{{asset(auth()->user()->picture->url ?? 'test/4.png') }}" alt="user photo">
                        </button>
                    </div>
                    <div class="z-50 hidden my-4 text-base list-none divide-y rounded shadow bg-gray-700 divide-gray-600"
                        ...
                        <ul class="py-1" role="none">
                            ...
                            <li>
                                ...
                                <form id="logout-form" action="{{ route('logout') }}" method="POST" class="hover:bg-gray-600 ">
                                    @csrf
                                    <button type="submit" class="block px-4 py-2 text-sm text-gray-300 hover:text-white">Se déconnecter</button>
                                </form>
                            </li>
                        </ul>
                    </div>
