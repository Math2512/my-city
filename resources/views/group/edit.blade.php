                ...
                <form method="POST" action="{{ route('groups.update', $group->id) }}" class="" enctype="multipart/form-data">
                    <div class="p-6 space-y-6">
                        ...
                        <div class="mb-5">
                            ...
                            <select name="group_managers[]" id="choices" class="select2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" multiple>
                        ...
                        <div class="mb-5" wire:ignore>
                            @livewire('tag-manager', ['groupId' => $group->id])
                        </div>
                        <button type="submit"
